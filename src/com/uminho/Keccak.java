...
/**
 * Class that implements the Keccak algorithm, as submitted to
 * the SHA-3 final round, which it won. This implementation
 * follows the Python reference from the authors of the algorithm
 * closely.
 *
 * Please note, this class logs debugging info. If you need to
 * access that information please use Log.set(Log.LEVEL_DEBUG).
 *
 * @see PIProvider
 * @see SHA3MessageDigest
 * @see <a href="http://keccak.noekeon.org">Keccak website</a>
 * @see <a href="http://keccak.noekeon.org/KeccakInPython-3.0.zip">Keccak Python reference implementation</a>
 * @see <a href="http://keccak.noekeon.org/Keccak-reference-3.0.pdf">The Keccak reference</a>
 * @see <a href="http://keccak.noekeon.org/Keccak-implementation-3.2.pdf">Keccak implementation overview</a>
 *
...
public class Keccak {
    ...
    throws InvalidAlgorithmParameterException {
        ...
        switch (size) {
            ...
            default: throw new InvalidAlgorithmParameterException("The size of the digest should be 224, 256, 384 or 512.");
        }
